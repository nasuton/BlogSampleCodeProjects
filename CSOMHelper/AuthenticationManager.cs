...
namespace Csharp_SampleProjects.CSOM
{
    public class AuthenticationManager : IDisposable
    {
        ...
        // Azure上で取得できる、OAuth 2.0 トークン エンドポイント (v1)を使用
        private const string tokenEndpoint = "https://login.microsoftonline.com/TenantId/oauth2/token";

        // 使用するAzureアプリIDを指定する
        private const string defaultAADAppId = "AzureアプリID";
